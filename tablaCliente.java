...
public class tablaCliente extends javax.swing.JFrame {
    ...
    public tablaCliente() {
        ...
        try{
            ...
            String sql = "SELECT id_clint, usuario, contraseña, nombre, numeroCedula, ubicacion, correo, telefono  FROM CLIENTE";
            ...
            modelo4.addColumn("id_clint");
            modelo4.addColumn("usuario");
            modelo4.addColumn("contraseña");
            modelo4.addColumn("nombre");
            modelo4.addColumn("numeroCedula");
            modelo4.addColumn("ubicacion");
            modelo4.addColumn("correo");
    ...
    private void initComponents() {
        ...
        jCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id_clint", "usuario", "contraseña", "nombre", "numeroCedula", "ubicacion", "correo", "telefono"
            }
        ) {
